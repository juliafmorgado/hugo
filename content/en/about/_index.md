...
Now, as a Principal Developer Relations Engineer at Dash0, Julia helps developers adopt open standards like OpenTelemetry and build practical observability workflows. Dash0 is an OpenTelemetry-native, AI-driven observability platform focused on real-world use cases and efficient, standards-based data pipelines. Julia’s work sits at the intersection of community, product, and education—translating complex concepts into actionable practices that improve resilience, efficiency, and scalability.

Julia is an experienced speaker who has presented on [technical and leadership topics](https://github.com/juliafmorgado/talks) at conferences worldwide in four languages. She also organizes events like the [Kubernetes Community Days NY](https://community.cncf.io/kcd-new-york/), [AWS Community Day New York](https://www.awscommunitynewyork.com/), and [CNCF Meetup NYC](https://community.cncf.io/cloud-native-midtown/), bringing together people from diverse backgrounds to exchange ideas, collaborate, and innovate.
